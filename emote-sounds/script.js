...
async function generateHTML() {
    ...
    const handleMessageFn = [
        ...
        "  for(const k in allStreaks){if(k!==matchedEmote)allStreaks[k]=0;}",
        ...
        "  if(streakCount>=emoteConfig.min_streak&&streakCount%emoteConfig.min_streak===0){",
        "    log('streak reached for '+matchedEmote+' (x'+streakCount+')','streak');",
